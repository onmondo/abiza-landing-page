    ...
    <nav className="fixed w-full z-50 transition-all duration-300" id="navbar">
      ...
      <div id="mobile-menu" className="hidden md:hidden bg-white shadow-lg absolute w-full">
        <div className="px-4 pt-2 pb-6 space-y-2">
          <a href="#about" className="block px-3 py-2 text-deep-sea hover:text-terracotta">Our Story</a>
          {/* <a href="#rooms" className="block px-3 py-2 text-deep-sea hover:text-terracotta">Rooms</a> */}
          <a href="#location" className="block px-3 py-2 text-deep-sea hover:text-terracotta">Location</a>
